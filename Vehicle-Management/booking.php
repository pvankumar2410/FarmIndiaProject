    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1 style="text-align:center;">Tractor Booking</h1>
                 <?php //echo $msg; ?>
            </div>
            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="tractor">tractor</label> &nbsp;
                      <label><input type="radio" name="type" value="lorry">lorry</label>
                    </div>
                    <br>
                    <div class="input-group">
