   ...
   <div class="container"> 
     <div class="row">
        ...
        <div class="page-header">
            <h1 style="text-align: center;">New Job Form </h1>
            <?php echo $msg; ?>
      </div> 
       <div class="col-md-3">
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <br> 
                 ...
                 <div class="input-group">
                  ...
                  <label class="radio-inline">
                      <input type="radio" name="type" value="bus">Lorry
                    </label>
                <label class="radio-inline">
                  <input type="radio" name="type" value="car">car
                </label>
                 <label class="radio-inline">
                  <input type="radio" name="type" value="car">others
                </label>
                </div>
                <br> 
                
                 <div class="input-group">
                  <span class="input-group-addon"><b>Contact No</b></span>
                  <input id="vehchesis" type="text" class="form-control" name="vehchesis" placeholder="Contact no">
                </div>
                <br> 
                
                <div class="input-group">
                  <span class="input-group-addon"><b>Brand/Company</b></span>
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Last Date of Registration</b></span>
                ...
                -->
                <div class="input-group">
                  <span class="input-group-addon"><b>Company Photo/logo</b></span>
