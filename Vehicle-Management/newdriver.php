   ...
   <div class="container"> 
     <div class="row">
        ...
        <div class="page-header">
            <h1 style="text-align: center;">New Jobs</h1>
            <?php echo $msg; ?>
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" >
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>Company Name</b></span>
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>Farmers Joining Date</b></span>
             ...
             <!--     <input id="drlicense" type="text" class="form-control" name="drlicense" placeholder="License No">  -->
                  <textarea rows="5" id="draddress" type="text" class="form-control" name="drlicense" placeholder="description"> </textarea>

                </div>
                <br>
                
                 <div class="input-group">
                  <span class="input-group-addon"><b>Job End Date</b></span>
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Employer Address</b></span>
