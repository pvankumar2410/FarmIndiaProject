            ...
            <div class="row">
                ...
                <div class="user">
                      ...
                      <div class = "loginalign">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="" id="login_now">Login</a></li>
                        </div>
                      <?php endif; ?>
                      </div>
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> Weather Forecasting
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Auction Facility
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Search Farming Jobs
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Rent a Agricultural Equipments
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i> Pesticides
                                </li>
                                <li>
                                    <i class="fab fa-opencart"></i>Real Time Price of Crops
                                </li>
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> FarmIndia</strong></h1>
                            <p class="m-b-40">Jai Kisan<br>Farming is not a Job , its a part of life</p>
                            <p><a class="btn hvr-hover" href="#">About Us</a></p>
                        </div>
                    </div>
                </div>
            </li>
                ...
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            ...
                            <button data-filter=".best-seller">Coming Soon</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            <button class="active" data-filter="*">Available</button>
                            <button data-filter=".top-featured">Top</button>
                            <button data-filter=".best-seller">Emergency</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
                            <button class="active" data-filter="*">All</button>
                            <button data-filter=".top-featured">latest</button>
                            <button data-filter=".best-seller">Top </button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3>Pesticides </h3>
                                <p>Know what pesticide is used for a crop</p>
                            </div>
                            <ul class="option-blog">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
							...
							<p>FarmIndia also helps the Farmers to Rent the Agricultural Equipments for their use and also provides knowledge about the crops/weather forecasting/pesticides.
</p> 							
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><i class="fas fa-envelope"></i>Email: <a href="mailto:tejareddy8303@gmail.com">contact tejareddy8303@gmail.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
