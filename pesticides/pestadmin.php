...
<head>
	...
	body {
		...
		box-shadow: 0px 0px 10px 0px #787878;	margin-top:50px;	padding:10px;
}	.img{
...
<div class="post">
	<span><h3><?= $msg;?></h3></span>
		<form method="post" name="post" action="" enctype="multipart/form-data">
			...
			<input type="text" name="dat"  placeholder="About Pesticdes" value="<?= $dat;?>">
			<file>Select Image
			<input type="file" name="img" class="file" accept="*/image">
			</file>
			<input type="submit" class="submit" name="<?= $btsav;?>" value="<?= $btsav;?>">
			<input type="submit" class="submit Can" name="Cansel" value="Cansel">
		</form>
<!-- Uploadet Data -->
<?php
...
echo "
		<div class='img' style='background:url(img/$img.png)  no-repeat left top ;background-size:150px;'>
			...
			<edit><a href='?Edit=$img'>Edit</a><a href='?Dell=$img'>Dell</a></edit>
		</div>
";
}}
?>
